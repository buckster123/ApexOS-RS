...
| 7 | `apexos-update` not idempotent — can flip a headless Pi into kiosk on update | Bug | high | `install.sh:367-369,788-797` |
...
- **Vendor agentd's `apexos-core` crate for shared Event types** — CLAUDE.md (Deferred). Avoids fragile JSON string-matching in UI; blocked on agentd publishing core as a library crate. **[low]**
