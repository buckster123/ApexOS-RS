...
| **P4d — Store-and-forward** | Flash queue on the `apexnet` partition; drain on neighbour appearance | **Yes** | A queued message survives a brainstem power cycle and is delivered when the peer returns |
