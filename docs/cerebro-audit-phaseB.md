...
- **Status sweep (2026-07-09)**: re-verified every finding against current code. The waves were largely executed (commits `1494e0b`/`f50ba92`/`700c739`/`39a5fb1`/`384582b`, graph prune #95, vec0 upsert #141, cognitive_bootstrap `9c59b26`, audit-log wiring #243) — **27 of 30 FIXED** (CB-021 retention sweep 2026-07-09; CB-007/009/019 lock-discipline cluster + CB-029 input bounds 2026-07-10; CB-018 scoped destructive ops 2026-07-12), 1 mitigated at the agentd layer (CB-017), 2 still open (CB-003/008 — the two design-discussion items: dual-process graph divergence and the O(n) recall visibility map). Per-finding **Status** lines below; evidence text and line numbers remain the audit-time snapshot.
